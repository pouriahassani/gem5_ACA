...
# Setup the processor (single core, no switching)
...
# )
board = SimpleBoard(clk_freq="1GHz", processor=SimpleProcessor(cpu_type=CPUTypes.TIMING, isa=ISA.RISCV,num_cores=1), memory=SingleChannelDDR3_1600(size="512MB"),cache_hierarchy = cache_hierarchy)
...
#     + "m5 exit;"
# )
# Obtain the binary to run.
# binary = CustomResource("/workspaces/gem5/tests/test-progs/hello/bin/x86/linux/hello")
binary = obtain_resource(resource_id="riscv-crf")
# Set the syscall emulation workload with the binary.
